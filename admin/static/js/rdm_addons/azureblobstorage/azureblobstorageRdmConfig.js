/**
* Module that controls the Azure Blob Storage user settings. Includes Knockout view-model
* for syncing data.
*/
...
function ViewModel(url, institutionId) {
    ...
    self.account_url = url; //'/api/v1/settings/azureblobstorage/accounts/';
...
function AzureBlobStorageUserConfig(selector, url, institutionId) {
    // Initialization code
    var self = this;
