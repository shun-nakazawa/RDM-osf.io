        ...
        <td>
            % if document_type == 'registration':
                <div style="margin: 40px; background: white;">
					...
					<p>
					Learn more about <a href="${provider_url}">${reviewable.provider.name}</a> or <a href="https://osf.io/">GRDM</a>.
					<p>
					Sincerely,
                ...
                <div style="margin: 40px; background: white;">
                    ...
                    % else:
                        <p>
                            ...
                            ${document_type}
                            <a href="${reviewable.absolute_url}">${reviewable.title}</a>
                            on ${reviewable.provider.name}, which is hosted on the GRDM.
                        </p>
                    % endif
                          <p>
                            ...
                            <table style="padding: 0; border: 0;" width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                <tbody>
                                    <tr>
                                        <td>
                                        Now that you've shared your ${document_type}, take advantage of more GakuNin RDM features:
                                            <ul>
                                                <li>Upload supplemental, materials, data, and code to an GRDM project associated with your ${document_type}.
                    ...
                    % endif
                    <p>Learn more about <a href="${provider_url}">${reviewable.provider.name}</a> or <a href="https://osf.io/">GRDM</a>.</p>
                    <br>
                    <p>
                        Sincerely,<br>
