...
<tr>
  <td style="border-collapse: collapse;">
    ...
    <a href="${settings.DOMAIN}/registries/${reviewable.provider._id if reviewable.provider else 'osf'}">${reviewable.provider.name if reviewable.provider else "GRDM Registry"}</a>,
    ...
    % if not reviewable.branched_from_node:
      <p>
      Even if the registration is withdrawn, the <a href="${reviewable.registered_from.absolute_url}">GRDM Project</a>
