                ...
                <div class="btn-toolbar node-control pull-right">
                    ...
                    % else:
                        % if node.get('storage_limit_status') and permissions.ADMIN in user['permissions'] and not node['is_registration'] and not node['storage_limit_status']['canMakePrivate']:
                            <a class="storage-disabled btn btn-default" data-toggle="tooltip" style="opacity: .65;" data-placement="bottom" title="You cannot make your project private because you are above the storage limit for a private project.">${_("Make Private")}</a>
